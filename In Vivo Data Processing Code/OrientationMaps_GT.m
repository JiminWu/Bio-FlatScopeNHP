...
load M28D20220720R10TS.mat

fnTS = 'M28D20220720R10TS.mat';
...
X = 110:1:395;
Y = 110:1:390;
DisplayMap(RespCond(Y,X,:),LabelStim, ...
           sprintf(['Response map with low-pass filtration ', ...
                    '(%1.1f cyc/mm)'], ...
                   FermiHighCutOff));
DisplayMap(DPCond(Y,X,:),LabelStim, ...
...
hgfFig(end+1) = ...
  DisplayMap(RespCondFilt(Y,X,:),LabelStim, ...
